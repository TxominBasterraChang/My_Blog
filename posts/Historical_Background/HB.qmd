...
```{r out.width="100%"}
i_am("index.qmd")
TURNOUT_31 <- read_excel(here("Files", "Excel", "Voteshare_liberals.xlsx"))
A <- TURNOUT_31
...
```{r out.width="100%"}
i_am("index.qmd")
TURNOUT_31 <- read_excel(here("Files", "Excel", "TURNOUT.xlsx"))
A <- TURNOUT_31
...
```{r out.width="100%"}
load("/Users/txomin/Desktop/My_Blog/Files/Data_Frames/N_combined12.Rda")
A <- N_combined12
